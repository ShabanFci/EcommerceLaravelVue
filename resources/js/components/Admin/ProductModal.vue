            ...
            <div class="modal-wrapper">
                <div class="modal-container">
                    ...
                    <div class="modal-body">
                        <slot name="body">
                            Name: <input class="form-control" type="text" v-model="data.name">
                            Units: <input class="form-control" type="text" v-model="data.units">
                            Price: <input class="form-control" type="text" v-model="data.price">
